...
const resolvers = {
  ...
  Mutation: {
    signUp: async (_, { input }, { db }) => {
      //Hash the password from the query input
      ...
      // changes are below
      const opsID = result.insertedId;
      const actualResult = await db.collection("Users").findOne({ _id: opsID });
    ...
    deleteTaskList: async (_, { id }, { db, user }) => {
      ...
      // TODO Only collaborator of this task list should be able to delete
